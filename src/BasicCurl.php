 ...
 *
 * ```php
 * $curl = new nguyenanhung\CodeIgniter\BasicHelper\BasicCurl();
 ...
 *
 * @copyright PHP Curl/2.6 (+https://github.com/php-mod/curl)
 */
final class BasicCurl extends BaseHelper
{
     ...
     */
    const USER_AGENT = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:109.0) Gecko/20100101 Firefox/109.0';
